...
import DishwasherQuiz from '../../assets/dishwasher-quiz.png';
...
export const Dishwasher = () => {
    ...
    const onQuizItemSecondBlockClick = (quizItem: QuizItem) => {
        setQuizInformation({ ...quizInformation, type: `Посудомоечная машина: ${quizItem.title}` });
        setStep(step + 1);
    };
        ...
        <>
            ...
            <MainContainer>
                <Quiz>
                    ...
                    {step === 2 && (
                        <>
                            <Title>Какой тип посудомоечной машины по габаритам?</Title>
                            <QuizList>
                    ...
                    {step === 4 && (
                        <>
                            ...
                            <QuizCallback>
                                <StyledImage src={DishwasherQuiz} loading='lazy' />
                                <QuizCallBackForm>
                                    <QuizCallbackParagraph>
